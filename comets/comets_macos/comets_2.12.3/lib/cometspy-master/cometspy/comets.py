...
class comets:
    ...
    def __build_default_classpath_pieces(self):
        ...
        self.classpath_pieces['jna1'] = (self.COMETS_HOME +
                                           '/lib/or-tools/jna-5.12.1.jar')

        self.classpath_pieces['jna2'] = (self.COMETS_HOME +
                                           '/lib/or-tools/jna-jpms-5.12.1.jar')

        self.classpath_pieces['jna3'] = (self.COMETS_HOME +
                                           '/lib/or-tools/jna-platform-5.12.1.jar')

        self.classpath_pieces['jna4'] = (self.COMETS_HOME +
                                           '/lib/or-tools/jna-platform-jpms-5.12.1.jar')

        self.classpath_pieces['ortools1'] = (self.COMETS_HOME +
                                           '/lib/or-tools/ortools-java-9.11.4210-javadoc.jar')

        self.classpath_pieces['ortools2'] = (self.COMETS_HOME +
                                           '/lib/or-tools/ortools-java-9.11.4210-sources.jar')

        self.classpath_pieces['ortools3'] = (self.COMETS_HOME +
                                           '/lib/or-tools/ortools-java-9.11.4210.jar')

        self.classpath_pieces['ortools4'] = (self.COMETS_HOME +
                                           '/lib/or-tools/ortools-darwin-aarch64-9.11.4210-sources.jar')

        self.classpath_pieces['ortools5'] = (self.COMETS_HOME +
                                           '/lib/or-tools/ortools-darwin-aarch64-9.11.4210.jar')

        self.classpath_pieces['ortools6'] = (self.COMETS_HOME +
                                           '/lib/or-tools/protobuf-java-2.5.0.jar')
